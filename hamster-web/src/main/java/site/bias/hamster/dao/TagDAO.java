package site.bias.hamster.dao;

import site.bias.hamster.bean.vo.TagVO;
...
public interface TagDAO {
    ...
    /**
     * 获取tag id以 {@link site.bias.hamster.constant.Constants#SPLIT_CHARACTER}分隔的字符串
     ...
     * @param userCode 用户编码
     * @return 以 {@link site.bias.hamster.constant.Constants#SPLIT_CHARACTER}分隔的字符串
     */
